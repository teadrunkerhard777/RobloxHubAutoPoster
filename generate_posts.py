...
def schedule_image_posts(
    ...
    """
    Добавляет недостающие image-посты на 11:00, 17:00 и 21:00.
...
# --------------------------------------------------
# 11:00, 17:00, 21:00 — посты с картинками
#
# Старые image-слоты 12:00, 14:00 и 22:00 больше не создаются.
